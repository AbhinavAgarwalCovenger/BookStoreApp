...
//                    TextView navUserEmail = (TextView) headerView.findViewById(R.id.header_email);
                    CircleImageView mProfilePic = (CircleImageView) findViewById(R.id.profile_image);
                    navUsername.setText(customer.getName());
//                    navUserEmail.setText(customer.getEmail());
                    Glide.with(MainActivity.this).applyDefaultRequestOptions(new RequestOptions().placeholder(R.drawable.ic_launcher_background))
